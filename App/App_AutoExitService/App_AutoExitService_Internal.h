...
#define APP_AUTO_EXIT_STATUS_IDLE         (0x00u)
#define APP_AUTO_EXIT_STATUS_IN_PROGRESS  (0x01u)
#define APP_AUTO_EXIT_STATUS_COMPLETE     (0x02u)
#define APP_AUTO_EXIT_STATUS_BLOCKED      (0x03u)
#define APP_AUTO_EXIT_STATUS_STOPPED      (0x04u)
